    ...
    <div>
      ...
      <Card className="p-6 mb-6">
        <div className="flex flex-col sm:flex-row items-start gap-5">
          <div
            className={`w-20 h-20 rounded-2xl bg-gradient-to-br ${colorMap[product.imageColor] ?? "from-slate-400 to-slate-600"} flex items-center justify-center text-white font-bold text-xl shrink-0`}
          >
      ...
      <Card className="p-6 mb-6">
        <SectionTitle
          icon="payments"
          title="Pricing & Tax"
          description="Pricing and tax configuration for this product."
        />
      ...
      <Card className="p-6 mb-6">
        <SectionTitle
          ...
          description="Unit, size, and identification codes."
        />
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <Card className="p-6">
        <SectionTitle
          ...
          description="Description, usage, safety, and storage."
        />
