                ...
                {filtered.map((p) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-3.5">
                      <div
                        className={`w-11 h-11 rounded-xl bg-gradient-to-br ${colorMap[p.imageColor] ?? "from-slate-400 to-slate-600"} flex items-center justify-center text-white font-bold text-sm shrink-0`}
                      >
                        {initials(p.name)}
                      </div>
                    </td>
                    ...
                    <td className="px-5 py-3.5">
                      ...
                      <p className="text-xs text-slate-400 mt-0.5">
                        {p.productCategory} · {p.manufacturer}
                      </p>
                    </td>
                    {/* Unit */}
                    ...
                    {/* MRP */}
                    <td className="px-5 py-3.5 text-right text-slate-500 line-through">
                      {formatCurrency(p.mrp)}
                    </td>
                    {/* Stock */}
                    <td className="px-5 py-3.5 text-right">
                      <span
                        className={`font-semibold ${p.stock === 0 ? "text-red-500" : p.stock < 20 ? "text-amber-600" : "text-slate-700"}`}
                      >
                        {p.stock}
                      </span>
                    ...
                    <td className="px-5 py-3.5">
                      <div className="flex items-center justify-center gap-1">
                        ...
                        >
                          <Icon
                            name={
                              p.status === "Active" ? "toggle_on" : "toggle_off"
                            }
                            size={20}
                          />
                        </button>
