...
import { productSizes, productCategories, type TaxType } from "@/lib/data";
import {
  Card,
  Button,
  Input,
...
export default function ProductAddForm({
  ...
  const isFormValid =
    form.name && form.ProductCategory && form.unit && form.size;
      ...
      <div className="space-y-6">
        ...
        <Card className="p-6">
          <SectionTitle
            ...
            description="Basic product identification and ownership."
          />
        ...
        <Card className="p-6">
          <SectionTitle
            ...
            description="Unit, size, pricing, and tax code information."
          />
        ...
        <Card className="p-6">
          <SectionTitle
            ...
            description="Tax configuration based on interstate or intrastate supply."
          />
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <Select
              ...
              options={[
                { value: "Intrastate", label: "Intrastate (Within State)" },
                { value: "Interstate", label: "Interstate (Outside State)" },
              ]}
            />
            <Select
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    value={
                      form.taxType === "Intrastate"
                        ? String(Number(form.taxPercentage) / 2 || 0)
                        : "0"
                    }
                    readOnly
                ...
                <p className="text-xs text-slate-400 mt-1">
                  Auto-calculated as half of GST rate
                </p>
              </div>
              <div>
                <label className="block text-sm font-semibold text-slate-700 mb-1.5">
          ...
          {form.taxType === "Interstate" && (
            <div className="mt-4 animate-fade-in">
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1">
                  Auto-calculated as full GST rate for interstate supply
                </p>
              </div>
            </div>
          )}
        ...
        <Card className="p-6">
          <SectionTitle
            ...
            description="Product description, usage, safety, and storage information."
          />
            ...
            <div>
              ...
              <div className="flex gap-3">
                {["Active", "Inactive"].map((s) => (
                  ...
                  >
                    <span
                      className={`w-4 h-4 rounded-full flex items-center justify-center ${form.status === s ? (s === "Active" ? "bg-brand-500" : "bg-slate-400") : "bg-slate-200"}`}
                    >
                      {form.status === s && (
